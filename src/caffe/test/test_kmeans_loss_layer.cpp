...
class KmeansLossLayerTest : public MultiDeviceTest<TypeParam> {
 ...
 protected:
  ...
  void TestForward() {
    ...
    layer_param.mutable_clustering_loss_param()->set_beta(10);
    ...
    layer_param2.mutable_clustering_loss_param()->set_beta(10);
...
TYPED_TEST(KmeansLossLayerTest, TestGradient) {
  ...
  layer_param.mutable_clustering_loss_param()->set_beta(10);
  layer_param.mutable_clustering_loss_param()->set_num_center(dim);
  layer_param.mutable_clustering_loss_param()->set_lambda(1);
